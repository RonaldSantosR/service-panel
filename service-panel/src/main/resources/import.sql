...
INSERT [dbo].[item] ([item_id], [nombre], [descripcion], [ruta_imagen], [orden], [color_texto], [link_ruta],[tipo_item_id]) VALUES (1, 'SIMIH', 'Sistema de Mensajería In House','C:/Panel/logos/simih' ,1,'#269FC0', 'http://www.exact.com.pe/',1)
INSERT [dbo].[item] ([item_id], [nombre], [descripcion], [ruta_imagen], [orden], [color_texto], [link_ruta],[tipo_item_id]) VALUES (2, 'EXTERNUS', 'Sistema de expedición externa','C:/Panel/logos/externus' ,2, '#269FC0', 'http://www.exact.com.pe/',1)
INSERT [dbo].[item] ([item_id], [nombre], [descripcion], [ruta_imagen], [orden], [color_texto], [link_ruta],[tipo_item_id]) VALUES (3, 'RVA', 'Sistema de recogo de valijas en agencias','C:/Panel/logos/rva',3,'#269FC0', 'http://www.exact.com.pe/',1)
